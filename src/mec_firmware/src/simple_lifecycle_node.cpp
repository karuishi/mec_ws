...
class SympleLifecycleNode : public rclcpp_lifecycle::LifecycleNode
{
public:
explicit SympleLifecycleNode(const std::string &node_name, bool intra_process_comms=false)
...
{
    sub_ = create_subscription<std_msgs::msg::String>("chatter", 10, std::bind(&SympleLifecycleNode::msgCallBack, this, _1));
...
int main(int argc, char *argv[])
{
    ...
    std::shared_ptr<SympleLifecycleNode> simple_lifecycle_node = std::make_shared<SympleLifecycleNode>("simple_lifecycle_node");
